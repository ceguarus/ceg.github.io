...
var move = false,drag="",row=[],target=[],magnetismo=true,canvas;
		...
		var drawing = function(){
			...
			this.init = function(){
				$("body").append('<canvas id="canvas" width="'+$("#limit").width()+'" height="'+$(".jspPane").height()+'">This text is displayed if your browser does not support HTML5 Canvas.</canvas>');
